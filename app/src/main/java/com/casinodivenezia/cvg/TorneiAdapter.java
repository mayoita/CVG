...
public class TorneiAdapter extends ArrayAdapter<EventItem> {
    ...
    public TorneiAdapter(Context context, final int resource, List<TournamentItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (eventitemList.get(position).getImageTournament() != null)  {
            StorageReference imagesRef = storageRef.child(eventitemList.get(position).getImageTournament());
        ...
        holder.text.setText(eventitemList.get(position).getTournamentsName());
        holder.date.setText(formatMyDate(eventitemList.get(position).getStartDate()));
        holder.intro.setText(eventitemList.get(position).getTournamentDescription());
        ...
        final String textToSpeach = eventitemList.get(position).getTournamentDescription();
